...
final class HospitalUpdate extends HospitalState {}

final class HospitalCreateError extends HospitalState {
  final String error;

  HospitalCreateError(this.error);
}

final class HospitalCreateSuccess extends HospitalState {}

final class HospitalCreateLoading extends HospitalState {}
